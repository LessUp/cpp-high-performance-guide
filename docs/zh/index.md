...
<SectionIndex
  :items='[
    ...
    },
    {
      ...
      links: [
        { href: "./getting-started/quickstart", label: "快速开始" },
        { href: "./getting-started/prerequisites", label: "先决条件" },
      ],
    },
    {
      title: "性能分析",
      ...
      links: [
        { href: "./guides/profiling-guide", label: "性能分析" },
        { href: "./guides/optimization-decision-tree", label: "决策树" },
      ],
    },
    {
      title: "验证与 Sanitizer",
      ...
      links: [
        { href: "./guides/validation", label: "Sanitizer" },
        { href: "./guides/best-practices", label: "最佳实践" },
      ],
    },
  ]'
/>
